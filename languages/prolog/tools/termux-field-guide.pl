% Language Project Termux field guide for Prolog (SWI)
% Module id prolog
% Official Termux package set swi-prolog
% Runtime command swipl
% GitHub Linguist group Prolog
...
% 
% Prolog (SWI) recipe group 1 Safe file inspection
...
% Prolog (SWI) recipe group 1 Integrity and verification
...
% Prolog (SWI) recipe group 1 Text processing
...
% Prolog (SWI) recipe group 1 Structured data
...
% Prolog (SWI) recipe group 1 Project analysis
...
% Prolog (SWI) recipe group 1 Backup and restore
...
% Prolog (SWI) recipe group 1 Termux integration
...
% Prolog (SWI) recipe group 1 Performance work
...
% Prolog (SWI) recipe group 1 Cross language workflows
...
% Prolog (SWI) recipe group 1 Security boundaries
...
% Prolog (SWI) recipe group 1 Diagnostics
...
% Prolog (SWI) recipe group 1 Portable design
...
% Prolog (SWI) recipe group 2 Safe file inspection
...
% Prolog (SWI) recipe group 2 Integrity and verification
...
% Prolog (SWI) recipe group 2 Text processing
...
% Prolog (SWI) recipe group 2 Structured data
...
% Prolog (SWI) recipe group 2 Project analysis
...
% Prolog (SWI) recipe group 2 Backup and restore
...
% Prolog (SWI) recipe group 2 Termux integration
...
% Prolog (SWI) recipe group 2 Performance work
...
% Prolog (SWI) recipe group 2 Cross language workflows
...
% Prolog (SWI) recipe group 2 Security boundaries
...
% Prolog (SWI) recipe group 2 Diagnostics
...
% Prolog (SWI) recipe group 2 Portable design
