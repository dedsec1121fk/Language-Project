...
// Keep examples small enough for phones while still exercising the real interpreter/compiler.
// Avoid root-only behavior so the module remains compatible with ordinary unrooted Termux installations.
#let project = "Language Project"
#let features = ("Termux", "polyglot", "integrity", "tooling")
= Language Project / Typst
This module proves the Typst package is represented as an executable programmable typesetting language.
