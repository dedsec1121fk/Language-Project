\ Language Project Termux field guide for Forth
\ Module id forth
\ Official Termux package set gforth
\ Runtime command gforth
\ GitHub Linguist group Forth
...
\ 
\ Forth recipe group 1 Safe file inspection
...
\ Forth recipe group 1 Integrity and verification
...
\ Forth recipe group 1 Text processing
...
\ Forth recipe group 1 Structured data
...
\ Forth recipe group 1 Project analysis
...
\ Forth recipe group 1 Backup and restore
...
\ Forth recipe group 1 Termux integration
...
\ Forth recipe group 1 Performance work
...
\ Forth recipe group 1 Cross language workflows
...
\ Forth recipe group 1 Security boundaries
...
\ Forth recipe group 1 Diagnostics
...
\ Forth recipe group 1 Portable design
...
\ Forth recipe group 2 Safe file inspection
...
\ Forth recipe group 2 Integrity and verification
...
\ Forth recipe group 2 Text processing
...
\ Forth recipe group 2 Structured data
...
\ Forth recipe group 2 Project analysis
...
\ Forth recipe group 2 Backup and restore
...
\ Forth recipe group 2 Termux integration
...
\ Forth recipe group 2 Performance work
...
\ Forth recipe group 2 Cross language workflows
...
\ Forth recipe group 2 Security boundaries
...
\ Forth recipe group 2 Diagnostics
...
\ Forth recipe group 2 Portable design
