; Language Project Termux field guide for Common Lisp (ECL)
; Module id common-lisp
; Official Termux package set ecl
; Runtime command ecl
; GitHub Linguist group Common Lisp
...
; 
; Common Lisp (ECL) recipe group 1 Safe file inspection
...
; Common Lisp (ECL) recipe group 1 Integrity and verification
...
; Common Lisp (ECL) recipe group 1 Text processing
...
; Common Lisp (ECL) recipe group 1 Structured data
...
; Common Lisp (ECL) recipe group 1 Project analysis
...
; Common Lisp (ECL) recipe group 1 Backup and restore
...
; Common Lisp (ECL) recipe group 1 Termux integration
...
; Common Lisp (ECL) recipe group 1 Performance work
...
; Common Lisp (ECL) recipe group 1 Cross language workflows
...
; Common Lisp (ECL) recipe group 1 Security boundaries
...
; Common Lisp (ECL) recipe group 1 Diagnostics
...
; Common Lisp (ECL) recipe group 1 Portable design
...
; Common Lisp (ECL) recipe group 2 Safe file inspection
...
; Common Lisp (ECL) recipe group 2 Integrity and verification
...
; Common Lisp (ECL) recipe group 2 Text processing
...
; Common Lisp (ECL) recipe group 2 Structured data
...
; Common Lisp (ECL) recipe group 2 Project analysis
...
; Common Lisp (ECL) recipe group 2 Backup and restore
...
; Common Lisp (ECL) recipe group 2 Termux integration
...
; Common Lisp (ECL) recipe group 2 Performance work
...
; Common Lisp (ECL) recipe group 2 Cross language workflows
...
; Common Lisp (ECL) recipe group 2 Security boundaries
...
; Common Lisp (ECL) recipe group 2 Diagnostics
...
; Common Lisp (ECL) recipe group 2 Portable design
