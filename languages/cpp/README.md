...
- Native practical tool: **Word Frequency Analyzer** (`word-frequency`), category **text**.
...
```bash
language-project info cpp
language-project modules demo cpp
```
