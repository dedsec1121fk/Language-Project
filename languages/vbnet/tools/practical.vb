' Language Project practical module for Visual Basic .NET
...
Module Tool
 Sub Main(args As String())
  Console.WriteLine("Language Project / Visual Basic .NET")
  If args.Length > 0 AndAlso File.Exists(args(0)) Then Console.WriteLine("bytes=" & New FileInfo(args(0)).Length)
 End Sub
End Module
