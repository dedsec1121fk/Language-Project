# Fortran — Language Project Module
...
- Native practical tool: **Numeric Record Statistics** (`number-stats`), category **data**.
...
```bash
language-project info fortran
language-project modules demo fortran
```
