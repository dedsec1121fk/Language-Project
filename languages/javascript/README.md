# JavaScript — Language Project Module
...
- Native practical tool: **JSON Formatter/Minifier** (`json-format`), category **data**.
...
```bash
language-project info javascript
language-project modules demo javascript
```
