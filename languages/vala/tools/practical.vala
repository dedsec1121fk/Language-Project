// Language Project practical module for Vala
// Termux package(s): valac
...
using GLib;
int main(string[] args){ stdout.printf("Language Project / Vala\n"); if(args.length>1){ var f=File.new_for_path(args[1]); try { var info=f.query_info("standard::size",0); stdout.printf("bytes=%"+int64.FORMAT+"\n",info.get_size()); } catch(Error e){} } return 0; }
