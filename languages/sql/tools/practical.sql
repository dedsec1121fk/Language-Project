-- Language Project practical module for SQL (SQLite)
-- Termux package(s): sqlite
...
-- Language Project SQLite utility
CREATE TABLE IF NOT EXISTS values_lp(v INTEGER);
DELETE FROM values_lp;
INSERT INTO values_lp VALUES(1),(2),(3),(4),(5);
SELECT 'Language Project / SQL' AS banner, COUNT(*) AS count, SUM(v) AS sum, AVG(v) AS mean FROM values_lp;
