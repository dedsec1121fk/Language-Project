-- Language Project Termux field guide for SQL (SQLite)
-- Module id sql
-- Official Termux package set sqlite
-- Runtime command sqlite3
-- GitHub Linguist group SQL
...
-- 
-- SQL (SQLite) recipe group 1 Safe file inspection
...
-- SQL (SQLite) recipe group 1 Integrity and verification
...
-- SQL (SQLite) recipe group 1 Text processing
...
-- SQL (SQLite) recipe group 1 Structured data
...
-- SQL (SQLite) recipe group 1 Project analysis
...
-- SQL (SQLite) recipe group 1 Backup and restore
...
-- SQL (SQLite) recipe group 1 Termux integration
...
-- SQL (SQLite) recipe group 1 Performance work
...
-- SQL (SQLite) recipe group 1 Cross language workflows
...
-- SQL (SQLite) recipe group 1 Security boundaries
...
-- SQL (SQLite) recipe group 1 Diagnostics
...
-- SQL (SQLite) recipe group 1 Portable design
...
-- SQL (SQLite) recipe group 2 Safe file inspection
...
-- SQL (SQLite) recipe group 2 Integrity and verification
...
-- SQL (SQLite) recipe group 2 Text processing
...
-- SQL (SQLite) recipe group 2 Structured data
...
-- SQL (SQLite) recipe group 2 Project analysis
...
-- SQL (SQLite) recipe group 2 Backup and restore
...
-- SQL (SQLite) recipe group 2 Termux integration
...
-- SQL (SQLite) recipe group 2 Performance work
...
-- SQL (SQLite) recipe group 2 Cross language workflows
...
-- SQL (SQLite) recipe group 2 Security boundaries
...
-- SQL (SQLite) recipe group 2 Diagnostics
...
-- SQL (SQLite) recipe group 2 Portable design
