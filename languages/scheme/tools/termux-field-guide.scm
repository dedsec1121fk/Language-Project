; Language Project Termux field guide for Scheme (Guile)
; Module id scheme
; Official Termux package set guile
; Runtime command guile
; GitHub Linguist group Scheme
...
; 
; Scheme (Guile) recipe group 1 Safe file inspection
...
; Scheme (Guile) recipe group 1 Integrity and verification
...
; Scheme (Guile) recipe group 1 Text processing
...
; Scheme (Guile) recipe group 1 Structured data
...
; Scheme (Guile) recipe group 1 Project analysis
...
; Scheme (Guile) recipe group 1 Backup and restore
...
; Scheme (Guile) recipe group 1 Termux integration
...
; Scheme (Guile) recipe group 1 Performance work
...
; Scheme (Guile) recipe group 1 Cross language workflows
...
; Scheme (Guile) recipe group 1 Security boundaries
...
; Scheme (Guile) recipe group 1 Diagnostics
...
; Scheme (Guile) recipe group 1 Portable design
...
; Scheme (Guile) recipe group 2 Safe file inspection
...
; Scheme (Guile) recipe group 2 Integrity and verification
...
; Scheme (Guile) recipe group 2 Text processing
...
; Scheme (Guile) recipe group 2 Structured data
...
; Scheme (Guile) recipe group 2 Project analysis
...
; Scheme (Guile) recipe group 2 Backup and restore
...
; Scheme (Guile) recipe group 2 Termux integration
...
; Scheme (Guile) recipe group 2 Performance work
...
; Scheme (Guile) recipe group 2 Cross language workflows
...
; Scheme (Guile) recipe group 2 Security boundaries
...
; Scheme (Guile) recipe group 2 Diagnostics
...
; Scheme (Guile) recipe group 2 Portable design
