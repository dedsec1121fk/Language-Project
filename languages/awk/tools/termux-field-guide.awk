# Language Project Termux field guide for AWK
# Module id awk
# Official Termux package set gawk
# Runtime command gawk
# GitHub Linguist group Awk
...
# 
# AWK recipe group 1 Safe file inspection
...
# AWK recipe group 1 Integrity and verification
...
# AWK recipe group 1 Text processing
...
# AWK recipe group 1 Structured data
...
# AWK recipe group 1 Project analysis
...
# AWK recipe group 1 Backup and restore
...
# AWK recipe group 1 Termux integration
...
# AWK recipe group 1 Performance work
...
# AWK recipe group 1 Cross language workflows
...
# AWK recipe group 1 Security boundaries
...
# AWK recipe group 1 Diagnostics
...
# AWK recipe group 1 Portable design
...
# AWK recipe group 2 Safe file inspection
...
# AWK recipe group 2 Integrity and verification
...
# AWK recipe group 2 Text processing
...
# AWK recipe group 2 Structured data
...
# AWK recipe group 2 Project analysis
...
# AWK recipe group 2 Backup and restore
...
# AWK recipe group 2 Termux integration
...
# AWK recipe group 2 Performance work
...
# AWK recipe group 2 Cross language workflows
...
# AWK recipe group 2 Security boundaries
...
# AWK recipe group 2 Diagnostics
...
# AWK recipe group 2 Portable design
