...
- Native practical tool: **Tabular/TSV Statistics** (`tabular-stats`), category **data**.
...
```bash
language-project info awk
language-project modules demo awk
```
