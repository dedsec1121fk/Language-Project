// Language Project practical module for Solidity
...
// Language Project Solidity validation example
pragma solidity ^0.8.0;
contract LanguageProjectStats { function sum(uint256[] memory xs) public pure returns(uint256 s){ for(uint256 i=0;i<xs.length;i++){s+=xs[i];} } }
