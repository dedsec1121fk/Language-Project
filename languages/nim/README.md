...
- Native practical tool: **Line Ending Analyzer** (`eol-stats`), category **developer**.
...
```bash
language-project info nim
language-project modules demo nim
```
