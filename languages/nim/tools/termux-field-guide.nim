# Language Project Termux field guide for Nim
# Module id nim
# Official Termux package set nim
# Runtime command {data}/build/nim
# GitHub Linguist group Nim
...
# 
# Nim recipe group 1 Safe file inspection
...
# Nim recipe group 1 Integrity and verification
...
# Nim recipe group 1 Text processing
...
# Nim recipe group 1 Structured data
...
# Nim recipe group 1 Project analysis
...
# Nim recipe group 1 Backup and restore
...
# Nim recipe group 1 Termux integration
...
# Nim recipe group 1 Performance work
...
# Nim recipe group 1 Cross language workflows
...
# Nim recipe group 1 Security boundaries
...
# Nim recipe group 1 Diagnostics
...
# Nim recipe group 1 Portable design
...
# Nim recipe group 2 Safe file inspection
...
# Nim recipe group 2 Integrity and verification
...
# Nim recipe group 2 Text processing
...
# Nim recipe group 2 Structured data
...
# Nim recipe group 2 Project analysis
...
# Nim recipe group 2 Backup and restore
...
# Nim recipe group 2 Termux integration
...
# Nim recipe group 2 Performance work
...
# Nim recipe group 2 Cross language workflows
...
# Nim recipe group 2 Security boundaries
...
# Nim recipe group 2 Diagnostics
...
# Nim recipe group 2 Portable design
