...
- Native practical tool: **Extension Statistics** (`extension-stats`), category **files**.
...
```bash
language-project info d
language-project modules demo d
```
