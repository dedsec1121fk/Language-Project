# Language Project Termux field guide for C Shell
# Module id csh
# Official Termux package set csh
# Runtime command csh
# GitHub Linguist group Tcsh
...
# 
# C Shell recipe group 1 Safe file inspection
...
# C Shell recipe group 1 Integrity and verification
...
# C Shell recipe group 1 Text processing
...
# C Shell recipe group 1 Structured data
...
# C Shell recipe group 1 Project analysis
...
# C Shell recipe group 1 Backup and restore
...
# C Shell recipe group 1 Termux integration
...
# C Shell recipe group 1 Performance work
...
# C Shell recipe group 1 Cross language workflows
...
# C Shell recipe group 1 Security boundaries
...
# C Shell recipe group 1 Diagnostics
...
# C Shell recipe group 1 Portable design
...
# C Shell recipe group 2 Safe file inspection
...
# C Shell recipe group 2 Integrity and verification
...
# C Shell recipe group 2 Text processing
...
# C Shell recipe group 2 Structured data
...
# C Shell recipe group 2 Project analysis
...
# C Shell recipe group 2 Backup and restore
...
# C Shell recipe group 2 Termux integration
...
# C Shell recipe group 2 Performance work
...
# C Shell recipe group 2 Cross language workflows
...
# C Shell recipe group 2 Security boundaries
...
# C Shell recipe group 2 Diagnostics
...
# C Shell recipe group 2 Portable design
