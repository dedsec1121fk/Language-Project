# Language Project Termux field guide for POSIX sh (Dash)
# Module id dash
# Official Termux package set dash coreutils
# Runtime command dash
# GitHub Linguist group Shell
...
# 
# POSIX sh (Dash) recipe group 1 Safe file inspection
...
# POSIX sh (Dash) recipe group 1 Integrity and verification
...
# POSIX sh (Dash) recipe group 1 Text processing
...
# POSIX sh (Dash) recipe group 1 Structured data
...
# POSIX sh (Dash) recipe group 1 Project analysis
...
# POSIX sh (Dash) recipe group 1 Backup and restore
...
# POSIX sh (Dash) recipe group 1 Termux integration
...
# POSIX sh (Dash) recipe group 1 Performance work
...
# POSIX sh (Dash) recipe group 1 Cross language workflows
...
# POSIX sh (Dash) recipe group 1 Security boundaries
...
# POSIX sh (Dash) recipe group 1 Diagnostics
...
# POSIX sh (Dash) recipe group 1 Portable design
...
# POSIX sh (Dash) recipe group 2 Safe file inspection
...
# POSIX sh (Dash) recipe group 2 Integrity and verification
...
# POSIX sh (Dash) recipe group 2 Text processing
...
# POSIX sh (Dash) recipe group 2 Structured data
...
# POSIX sh (Dash) recipe group 2 Project analysis
...
# POSIX sh (Dash) recipe group 2 Backup and restore
...
# POSIX sh (Dash) recipe group 2 Termux integration
...
# POSIX sh (Dash) recipe group 2 Performance work
...
# POSIX sh (Dash) recipe group 2 Cross language workflows
...
# POSIX sh (Dash) recipe group 2 Security boundaries
...
# POSIX sh (Dash) recipe group 2 Diagnostics
...
# POSIX sh (Dash) recipe group 2 Portable design
