# POSIX sh (Dash) — Language Project Module
...
- Native practical tool: **PATH Audit** (`path-audit`), category **system**.
...
```bash
language-project info dash
language-project modules demo dash
```
