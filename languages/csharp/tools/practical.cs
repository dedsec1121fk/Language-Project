// Language Project practical module for C#
...
class Tool { static void Main(string[] a){ Console.WriteLine("Language Project / C#"); if(a.Length>0 && File.Exists(a[0])){var b=File.ReadAllBytes(a[0]); Console.WriteLine($"bytes={b.Length} sum={b.Aggregate(0L,(x,y)=>x+y)}");}}}
