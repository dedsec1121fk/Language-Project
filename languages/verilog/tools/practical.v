// Language Project practical module for Verilog
// Termux package(s): iverilog
...
// Language Project Verilog utility/simulation
module language_project; integer i; integer sum; initial begin sum=0; for(i=1;i<=5;i=i+1) sum=sum+i; $display("Language Project / Verilog sum=%0d",sum); $finish; end endmodule
