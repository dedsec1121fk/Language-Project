...
- Native practical tool: **Binary File Compare** (`file-compare`), category **files**.
...
```bash
language-project info java
language-project modules demo java
```
