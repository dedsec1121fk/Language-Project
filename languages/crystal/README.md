# Crystal — Language Project Module
...
- Native practical tool: **Duplicate Line Finder (Crystal)** (`duplicate-lines-cr`), category **text**.
...
```bash
language-project info crystal
language-project modules demo crystal
```
