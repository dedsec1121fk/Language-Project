...
- Native practical tool: **Largest Files** (`large-files`), category **files**.
...
```bash
language-project info fish
language-project modules demo fish
```
