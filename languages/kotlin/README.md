# Kotlin — Language Project Module
...
- Native practical tool: **Codebase Metrics** (`code-metrics`), category **developer**.
...
```bash
language-project info kotlin
language-project modules demo kotlin
```
