...
- Native practical tool: **Trim Trailing Whitespace** (`trim-lines`), category **text**.
...
```bash
language-project info sed
language-project modules demo sed
```
