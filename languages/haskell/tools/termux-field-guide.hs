-- Language Project Termux field guide for Haskell
-- Module id haskell
-- Official Termux package set ghc
-- Runtime command {data}/build/haskell
-- GitHub Linguist group Haskell
...
-- 
-- Haskell recipe group 1 Safe file inspection
...
-- Haskell recipe group 1 Integrity and verification
...
-- Haskell recipe group 1 Text processing
...
-- Haskell recipe group 1 Structured data
...
-- Haskell recipe group 1 Project analysis
...
-- Haskell recipe group 1 Backup and restore
...
-- Haskell recipe group 1 Termux integration
...
-- Haskell recipe group 1 Performance work
...
-- Haskell recipe group 1 Cross language workflows
...
-- Haskell recipe group 1 Security boundaries
...
-- Haskell recipe group 1 Diagnostics
...
-- Haskell recipe group 1 Portable design
...
-- Haskell recipe group 2 Safe file inspection
...
-- Haskell recipe group 2 Integrity and verification
...
-- Haskell recipe group 2 Text processing
...
-- Haskell recipe group 2 Structured data
...
-- Haskell recipe group 2 Project analysis
...
-- Haskell recipe group 2 Backup and restore
...
-- Haskell recipe group 2 Termux integration
...
-- Haskell recipe group 2 Performance work
...
-- Haskell recipe group 2 Cross language workflows
...
-- Haskell recipe group 2 Security boundaries
...
-- Haskell recipe group 2 Diagnostics
...
-- Haskell recipe group 2 Portable design
