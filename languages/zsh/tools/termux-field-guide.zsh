# Language Project Termux field guide for Z shell
# Module id zsh
# Official Termux package set zsh coreutils
# Runtime command zsh
...
# 
# Z shell recipe group 1 Safe file inspection
...
# Z shell recipe group 1 Integrity and verification
...
# Z shell recipe group 1 Text processing
...
# Z shell recipe group 1 Structured data
...
# Z shell recipe group 1 Project analysis
...
# Z shell recipe group 1 Backup and restore
...
# Z shell recipe group 1 Termux integration
...
# Z shell recipe group 1 Performance work
...
# Z shell recipe group 1 Cross language workflows
...
# Z shell recipe group 1 Security boundaries
...
# Z shell recipe group 1 Diagnostics
...
# Z shell recipe group 1 Portable design
...
# Z shell recipe group 2 Safe file inspection
...
# Z shell recipe group 2 Integrity and verification
...
# Z shell recipe group 2 Text processing
...
# Z shell recipe group 2 Structured data
...
# Z shell recipe group 2 Project analysis
...
# Z shell recipe group 2 Backup and restore
...
# Z shell recipe group 2 Termux integration
...
# Z shell recipe group 2 Performance work
...
# Z shell recipe group 2 Cross language workflows
...
# Z shell recipe group 2 Security boundaries
...
# Z shell recipe group 2 Diagnostics
...
# Z shell recipe group 2 Portable design
