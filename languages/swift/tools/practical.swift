// Language Project practical module for Swift
...
import Foundation
print("Language Project / Swift")
if CommandLine.arguments.count>1 { let p=CommandLine.arguments[1]; if let d=FileManager.default.contents(atPath:p){ print("bytes=\(d.count)") } }
