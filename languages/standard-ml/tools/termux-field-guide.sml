(* Language Project Termux field guide for Standard ML *)
(* Module id standard-ml *)
(* Official Termux package set polyml *)
(* Runtime command poly *)
(* GitHub Linguist group Standard ML *)
...
(*  *)
(* Standard ML recipe group 1 Safe file inspection *)
...
(* Standard ML recipe group 1 Integrity and verification *)
...
(* Standard ML recipe group 1 Text processing *)
...
(* Standard ML recipe group 1 Structured data *)
...
(* Standard ML recipe group 1 Project analysis *)
...
(* Standard ML recipe group 1 Backup and restore *)
...
(* Standard ML recipe group 1 Termux integration *)
...
(* Standard ML recipe group 1 Performance work *)
...
(* Standard ML recipe group 1 Cross language workflows *)
...
(* Standard ML recipe group 1 Security boundaries *)
...
(* Standard ML recipe group 1 Diagnostics *)
...
(* Standard ML recipe group 1 Portable design *)
...
(* Standard ML recipe group 2 Safe file inspection *)
...
(* Standard ML recipe group 2 Integrity and verification *)
...
(* Standard ML recipe group 2 Text processing *)
...
(* Standard ML recipe group 2 Structured data *)
...
(* Standard ML recipe group 2 Project analysis *)
...
(* Standard ML recipe group 2 Backup and restore *)
...
(* Standard ML recipe group 2 Termux integration *)
...
(* Standard ML recipe group 2 Performance work *)
...
(* Standard ML recipe group 2 Cross language workflows *)
...
(* Standard ML recipe group 2 Security boundaries *)
...
(* Standard ML recipe group 2 Diagnostics *)
...
(* Standard ML recipe group 2 Portable design *)
