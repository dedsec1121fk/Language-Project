...
- Native practical tool: **Key/Value Config Reader** (`kv-read`), category **data**.
...
```bash
language-project info lua
language-project modules demo lua
```
