-- Language Project Termux field guide for Lua
-- Module id lua
-- Official Termux package set lua54
-- Runtime command lua
-- GitHub Linguist group Lua
...
-- 
-- Lua recipe group 1 Safe file inspection
...
-- Lua recipe group 1 Integrity and verification
...
-- Lua recipe group 1 Text processing
...
-- Lua recipe group 1 Structured data
...
-- Lua recipe group 1 Project analysis
...
-- Lua recipe group 1 Backup and restore
...
-- Lua recipe group 1 Termux integration
...
-- Lua recipe group 1 Performance work
...
-- Lua recipe group 1 Cross language workflows
...
-- Lua recipe group 1 Security boundaries
...
-- Lua recipe group 1 Diagnostics
...
-- Lua recipe group 1 Portable design
...
-- Lua recipe group 2 Safe file inspection
...
-- Lua recipe group 2 Integrity and verification
...
-- Lua recipe group 2 Text processing
...
-- Lua recipe group 2 Structured data
...
-- Lua recipe group 2 Project analysis
...
-- Lua recipe group 2 Backup and restore
...
-- Lua recipe group 2 Termux integration
...
-- Lua recipe group 2 Performance work
...
-- Lua recipe group 2 Cross language workflows
...
-- Lua recipe group 2 Security boundaries
...
-- Lua recipe group 2 Diagnostics
...
-- Lua recipe group 2 Portable design
