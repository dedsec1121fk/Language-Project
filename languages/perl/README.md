...
- Native practical tool: **Recursive Regex Search** (`grep-context`), category **search**.
...
```bash
language-project info perl
language-project modules demo perl
```
