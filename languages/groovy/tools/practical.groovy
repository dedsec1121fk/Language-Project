// Language Project practical module for Groovy
...
println 'Language Project / Groovy'
if(args){ def f=new File(args[0]); if(f.exists()) println "bytes=${f.length()} lines=${f.readLines().size()}" }
