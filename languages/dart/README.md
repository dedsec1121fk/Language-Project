...
- Native practical tool: **JSONL Statistics** (`jsonl-stats`), category **data**.
...
```bash
language-project info dart
language-project modules demo dart
```
