% Language Project practical module for Objective-C
...
int main(int argc,char **argv){ @autoreleasepool { printf("Language Project / Objective-C\n"); if(argc>1) printf("path=%s\n",argv[1]); } return 0; }
