# Language Project Termux field guide for jq
# Module id jq
# Official Termux package set jq
# Runtime command jq
# GitHub Linguist group jq
...
# 
# jq recipe group 1 Safe file inspection
...
# jq recipe group 1 Integrity and verification
...
# jq recipe group 1 Text processing
...
# jq recipe group 1 Structured data
...
# jq recipe group 1 Project analysis
...
# jq recipe group 1 Backup and restore
...
# jq recipe group 1 Termux integration
...
# jq recipe group 1 Performance work
...
# jq recipe group 1 Cross language workflows
...
# jq recipe group 1 Security boundaries
...
# jq recipe group 1 Portable design
...
# jq recipe group 2 Safe file inspection
...
# jq recipe group 2 Integrity and verification
...
# jq recipe group 2 Text processing
...
# jq recipe group 2 Structured data
...
# jq recipe group 2 Project analysis
...
# jq recipe group 2 Backup and restore
...
# jq recipe group 2 Termux integration
...
# jq recipe group 2 Performance work
...
# jq recipe group 2 Cross language workflows
...
# jq recipe group 2 Security boundaries
...
# jq recipe group 2 Portable design
