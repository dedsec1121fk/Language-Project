...
# Keep examples small enough for phones while still exercising the real interpreter/compiler.
# Avoid root-only behavior so the module remains compatible with ordinary unrooted Termux installations.
# Language Project Gnuplot utility
# Generates a deterministic data summary plot script without network access.
set terminal dumb 80 20
set title "Language Project deterministic sample"
set xlabel "x"
set ylabel "x^2"
plot x*x title "square"
