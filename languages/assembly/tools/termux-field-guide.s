// Language Project Termux field guide for Assembly (AArch64)
// Module id assembly
// Official Termux package set clang
// Runtime command clang
// GitHub Linguist group Assembly
...
// 
// Assembly (AArch64) recipe group 1 Safe file inspection
...
// Assembly (AArch64) recipe group 1 Integrity and verification
...
// Assembly (AArch64) recipe group 1 Text processing
...
// Assembly (AArch64) recipe group 1 Structured data
...
// Assembly (AArch64) recipe group 1 Project analysis
...
// Assembly (AArch64) recipe group 1 Backup and restore
...
// Assembly (AArch64) recipe group 1 Termux integration
...
// Assembly (AArch64) recipe group 1 Performance work
...
// Assembly (AArch64) recipe group 1 Cross language workflows
...
// Assembly (AArch64) recipe group 1 Security boundaries
...
// Assembly (AArch64) recipe group 1 Diagnostics
...
// Assembly (AArch64) recipe group 1 Portable design
...
// Assembly (AArch64) recipe group 2 Safe file inspection
...
// Assembly (AArch64) recipe group 2 Integrity and verification
...
// Assembly (AArch64) recipe group 2 Text processing
...
// Assembly (AArch64) recipe group 2 Structured data
...
// Assembly (AArch64) recipe group 2 Project analysis
...
// Assembly (AArch64) recipe group 2 Backup and restore
...
// Assembly (AArch64) recipe group 2 Termux integration
...
// Assembly (AArch64) recipe group 2 Performance work
...
// Assembly (AArch64) recipe group 2 Cross language workflows
...
// Assembly (AArch64) recipe group 2 Security boundaries
...
// Assembly (AArch64) recipe group 2 Diagnostics
...
// Assembly (AArch64) recipe group 2 Portable design
