...
- Native practical tool: **Unique Line Filter** (`unique-lines`), category **text**.
...
```bash
language-project info ruby
language-project modules demo ruby
```
