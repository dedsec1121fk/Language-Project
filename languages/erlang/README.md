# Erlang — Language Project Module
...
- Native practical tool: **Line Statistics** (`line-stats`), category **text**.
...
```bash
language-project info erlang
language-project modules demo erlang
```
