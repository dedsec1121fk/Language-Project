# Language Project Termux field guide for Bash
# Module id bash
# Official Termux package set bash coreutils
# Runtime command bash
...
# 
# Bash recipe group 1 Safe file inspection
...
# Bash recipe group 1 Integrity and verification
...
# Bash recipe group 1 Text processing
...
# Bash recipe group 1 Structured data
...
# Bash recipe group 1 Project analysis
...
# Bash recipe group 1 Backup and restore
...
# Bash recipe group 1 Termux integration
...
# Bash recipe group 1 Performance work
...
# Bash recipe group 1 Cross language workflows
...
# Bash recipe group 1 Security boundaries
...
# Bash recipe group 1 Diagnostics
...
# Bash recipe group 1 Portable design
...
# Bash recipe group 2 Safe file inspection
...
# Bash recipe group 2 Integrity and verification
...
# Bash recipe group 2 Text processing
...
# Bash recipe group 2 Structured data
...
# Bash recipe group 2 Project analysis
...
# Bash recipe group 2 Backup and restore
...
# Bash recipe group 2 Termux integration
...
# Bash recipe group 2 Performance work
...
# Bash recipe group 2 Cross language workflows
...
# Bash recipe group 2 Security boundaries
...
# Bash recipe group 2 Diagnostics
...
# Bash recipe group 2 Portable design
