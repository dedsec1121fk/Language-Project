...
- Native practical tool: **Regex Line Filter** (`regex-filter`), category **text**.
...
```bash
language-project info tcl
language-project modules demo tcl
```
