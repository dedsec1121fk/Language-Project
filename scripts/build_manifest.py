...
ignore={'MANIFEST.json'};skip_roots={'build','state','results','bundles','.git','__pycache__'};rows=[]
...
(ROOT/'MANIFEST.json').write_text(json.dumps({'schema':2,'project':'Language Project','file_count':len(rows),'files':rows},indent=2)+'\n')
